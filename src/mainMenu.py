...
class MainMenu:
    ...
    def initialize_pygame(self):
        ...
        self.background = pygame.image.load("C:/Users/carli/Documents/Proyectos/SimuladorCuerposEquilibrioNew/assets/img/fondo_menu.png")
        self.background = pygame.transform.scale(self.background, (1350, 840))
        self.main_logo = pygame.image.load("C:/Users/carli/Documents/Proyectos/SimuladorCuerposEquilibrioNew/assets/img/logo.png")
        self.main_logo = pygame.transform.scale(self.main_logo, (500, 400))
        self.author_logo = pygame.image.load("C:/Users/carli/Documents/Proyectos/SimuladorCuerposEquilibrioNew/assets/img/author_logo.png")
